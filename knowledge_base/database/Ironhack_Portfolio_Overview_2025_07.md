...
- **Duration**: 400 hours (40 hours prework + 360 hours course)
- **Technologies**: Python, SQL, Pandas, NumPy, Tableau, Plotly, Scikit-learn, PyTorch and/or TensorFlow/Keras, MLOps, computer vision, NLP, RAG/LLM (e.g., LangChain, OpenAI APIs)
- **Capstone**: End-to-end data science solution (data handling, modeling, and presentation)
